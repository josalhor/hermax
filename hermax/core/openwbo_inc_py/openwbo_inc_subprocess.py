...
class OpenWBOInc(OneShotSubprocessReplaySolverBase):
    ...
    def worker_solver_class_path(self) -> str:
        return "hermax.core.openwbo_inc_py.openwbo_inc_solver.OpenWBOIncSolver"

    @property
    def default_signature(self) -> str:
        return "Open-WBO-Inc (subprocess wrapper)"
    ...
    def is_available(cls) -> bool:
        if importlib.util.find_spec("hermax.core.openwbo_inc") is None:
            return False
        mod_name = "hermax.core.openwbo_inc_py.openwbo_inc_solver"
