...
_WORKER_SOLVER_CLASS = "hermax.core.nuwls_c_ibr_py.nuwls_c_ibr_solver.NuWLSCIBRSolver"


class NuWLSCIBR(IPAMIRSolver):
    """
    NuWLS-c-IBR fake-incremental wrapper with subprocess isolation.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._last_signature: str = "NuWLS-c-IBR (subprocess wrapper)"
    ...
    def solve(
        ...
        if run.timed_out and run.response is None:
            ...
            if raise_on_abnormal:
                raise RuntimeError("NuWLS-c-IBR worker timed out")
            return False
    ...
    def _apply_fallback_solver_output(self, exit_code: Optional[int], text: str) -> None:
        ...
        self._status = st
        self._last_signature = "NuWLS-c-IBR (subprocess worker/native binding)"
