...
def test_gswc_edge_cases(pbamo_module, pb_baseline, card_baseline, sat_solver_name: str, case: dict[str, object]) -> None:
...
def test_gswc_small_random_smoke(pbamo_module, pb_baseline, card_baseline, sat_solver_name: str) -> None:
...
def test_gswc_handles_high_top_id(pbamo_module, pb_baseline, card_baseline, sat_solver_name: str) -> None:
    assert_encoding_matches_oracle_and_baseline(
        pbamo_module=pbamo_module,
        pb_baseline=pb_baseline,
        card_baseline=card_baseline,
