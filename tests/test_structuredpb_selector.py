...
def test_pbamo_available_encoders_include_new_ones(pbamo_module) -> None:
    names = set(pbamo_module.available_encoders())
    assert {"best", "mdd", "gswc", "ggpw", "gmto", "rggt"} <= names


def test_pbamo_best_smoke_matches_baseline(
