...
- Hard vs soft clause semantics via small formulas
...
class _ModelCheckingSolverProxy:
    ...
    - returned cost matches recomputation under wrapper soft semantics
    """
...
class TestTTOpenWBOIncIncomplete(TestIPAMIRSolverHardcore):
    ...
    def test_060_random_mini_instances_match_bruteforce(self):
        self.skipTest("TTOpenWBOInc is incomplete; brute-force optimum matching is not required.")
