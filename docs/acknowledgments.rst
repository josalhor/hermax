...
* Aditya Joshi, Ruben Martins, Vasco Manquinho.
  *Open-WBO-Inc: An Incremental MaxSAT Solver*. JSAT 11(1), 2019.
* Shiwei Pan, Yiyuan Wang, Shaowei Cai.
  *An Efficient Core-Guided Solver for Weighted Partial MaxSAT*. IJCAI 2025.
* Xiangyu Jiang et al.
  *Enhancing Diversity and Intensity in Local Search for (Weighted) Partial MaxSAT*.
  SAT 2025.
* Jiayi Chu, Chuan Luo, et al.
  *NuWLS-c-IBR*. MaxSAT Evaluation solver description, 2023.
* K. Lübke, A. Niskanen.
  *Loandra: Local Search Meets Core-Guided MaxSAT*.
  MaxSAT Evaluation solver description, 2025.
